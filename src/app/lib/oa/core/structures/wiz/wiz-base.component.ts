import { ErrorHandler, EventEmitter, OnDestroy, OnInit, Output, Directive } from '@angular/core';
import { ActivatedRoute, Router } from '@angular/router';
import { Observable } from 'rxjs';
import { IBreadcrumbHandler } from '../../services/breadcrumb-handler.interface';
import { IContextMenuHandler } from '../../services/context-menu-handler.interface';
import { IEntityHandler } from '../../services/entity-handler.interface';
import { ITitleHandler } from '../../services/title-handler.interface';
import { IWizStep } from './wiz-step.interface';

@Directive()
export abstract class WizBaseComponent implements OnInit, OnDestroy {
  ...
  isProcessing = false;
  afterCreate: (item) => void;
  abstract onSave(): Observable<any> | boolean;
  abstract onChange(item);
  ...
  ngOnDestroy(): void {
    ...
    this.breadcrumbHandler.resetBreadcrumb();
    this.contextMenuHandler.resetContextMenu();
    this.entityHandler.resetEntity();
  }
